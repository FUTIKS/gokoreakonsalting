  ...
  return (
    <div className="relative container mx-auto py-20 text-white overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        {/* Jamoa a'zolari - button o'rniga div, onClick olib tashlandi */}
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 place-items-center">
          {teamMembers.map((member, index) => (
            <div key={index} className="text-center group transition-transform duration-300 hover:scale-105 relative z-10 flex flex-col items-center">
              <img
                src={member.image}
                alt={member.name}
